...
Import and tidy the Mr. Trash Wheel sheet: \#\#\# Why can't I directly select A:N
...
The "trash\_wheel\_data" consists of 14 variables and 215 observations. These variables are "dumpster, month, year, date, weight, volume, plastic\_bottles, polystyrene, cigarette\_butts, glass\_bottles, grocery\_bags, chip\_bags, sports\_balls, homes\_powered", mainly documenting weight and date of trash and its types.

The "precipit\_data" consists of 3 variables and 20 observations. The key variables are precipitation in each month of 2016 and 2017. The total precipitation in 2017 is 29.93 and the median number of sports balls in a dumpster in 2016 is 26.
...
There are 2125 unique locations in the dataset.
